...
type Sim struct {
	...
	// Names of Layers to which Training and Testing values are applied. used in ConfigNet and ApplyInputs
	LayNms	[]string `view:"no-inline" desc:"Names of Layers to which Training and Testing values are applied"`
