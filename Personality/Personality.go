...
// Update the relevant Struc fields on the left side of the GUI to display the current values.
...
func (ss *Sim) ConfigGui() *gi.Window {
	...
	gi.SetAppAbout(`This is the initial Personality Model.</p>`)
	...
	tbar.AddAction(gi.ActOpts{Label: "TrainPIT", Icon: "run", Tooltip: "Starts the network training, picking up from wherever it may have left off.  If not stopped, training will complete the specified number of Runs through the full number of Epochs of training, with testing automatically occuring at the specified interval.",
